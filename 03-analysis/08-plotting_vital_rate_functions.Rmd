...
beta_s_names =   
  data.frame(
      param = c('beta_s[1]', 'beta_s[2]', 'beta_s[3]', 'beta_s[4]', 'beta_s[5]',
                ...
                'beta_s[11]', 'beta_s[12]', 'beta_s[13]', 'beta_s[14]',
                'beta_s[15]', 'beta_s[16]', 'beta_s[17]', 'beta_s[18]'),
...
beta_g_names =     
  data.frame(
      param = c('beta_g[1]', 'beta_g[2]', 'beta_g[3]', 'beta_g[4]', 'beta_g[5]',
                ...
                'beta_g[11]', 'beta_g[12]', 'beta_g[13]', 'beta_g[14]',
                'beta_g[15]', 'beta_g[16]', 'beta_g[17]', 'beta_g[18]'),
      data_name = c('intercept', 'dbh_m.init', 
                                           'dbh_m2.init', 'fire', 
                                     'wpbr','ba_scaled', 'cwd_dep90_scaled', 
                                     'cwd_mean_scaled', 'dbh_fire', 'dbh2_fire',
...
beta_f_names =   
  data.frame(
      param = c('beta_f[1]', 'beta_f[2]', 'beta_f[3]', 'beta_f[4]', 'beta_f[5]',
                ...
                'beta_f[11]', 'beta_f[12]', 'beta_f[13]', 'beta_f[14]',
                'beta_f[15]', 'beta_f[16]', 'beta_f[17]', 'beta_f[18]'),
      data_name = c('intercept', 'dbh_m.init', 
                                           'dbh_m2.init', 'fire', 
                                     'wpbr','ba_scaled', 'cwd_dep90_scaled', 
                                     'cwd_mean_scaled', 'dbh_fire', 'dbh2_fire',
...
summary_f = 
  pila_fit$summary(variables = c('beta_f', 'sigmaEco_f', 'kappa_r')) %>%
  left_join(beta_f_names %>%
              bind_rows(
                data.frame(param = c('sigmaEco_f',
                                     'kappa_r'),
                       position = c('19', '20'),
                       pretty_name = c('SD Ecoregions', 'NB Dispersion'))
              ),
            by = c('variable' = 'param')) %>%
  select(Position = position,
         Parameter = pretty_name, 
...
## the subplot-level mean (so like the average subplot))
  expand.grid('intercept' = 1,
            'dbh_m.init' = seq(from = 0, to = 2.5, by = 0.01),
            'fire' = 0,
            'wpbr' = 0,
            'ba_scaled' = 0,
            'cwd_dep90_scaled' = 0,
    ...
    do.call('rbind',
            lapply(X = 1:4000,
                   FUN = function(i){
                     ...
                     X = dataset[,c('intercept', 'dbh_m.init','dbh2_m.init', 'fire', 
                                    'wpbr', 'ba_scaled', 
                                    'cwd_dep90_scaled', 'cwd_mean_scaled', 
